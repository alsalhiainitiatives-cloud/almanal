...
export const Route = createFileRoute("/_authenticated/admin/permissions")({
  head: () => ({
    meta: [
      { title: "مصفوفة الصلاحيات | بوابة المنال" },
      {
        name: "description",
        content: "التحكم في منح وسحب صلاحيات كل دور في بوابة مدارس وروضة المنال.",
      },
      { property: "og:title", content: "مصفوفة الصلاحيات | بوابة المنال" },
      { property: "og:description", content: "منح وسحب الصلاحيات لكل دور بشكل فوري وآمن." },
...
function PermissionsPage() {
  ...
  return (
    <PortalLayout
      ...
      description="فعّل أو ألغِ الصلاحية لكل دور بالضغط على المربّع — التغيير يُطبَّق فورًا على كل المستخدمين المرتبطين بالدور ويُسجَّل في سجل العمليات."
    >
