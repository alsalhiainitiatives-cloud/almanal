    ...
    pillars: [
      {
        icon: "Target",
        title: "رسالتنا",
        body: "تعليم نوعي يوازن بين المعرفة والقيم في بيئة آمنة ومحبّة.",
      },
      {
        icon: "Compass",
        title: "رؤيتنا",
        body: "أن نكون الخيار الأول للأسر في عنيزة في تعليم الطفولة المبكرة والابتدائية.",
      },
      {
        icon: "Heart",
        title: "قيمنا",
        body: "الأمان، الرحمة، الإتقان، والشراكة الحقيقية مع الأسرة.",
      },
    ],
  },
};
