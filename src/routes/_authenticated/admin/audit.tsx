...
export const Route = createFileRoute("/_authenticated/admin/audit")({
  head: () => ({
    meta: [
      { title: "سجل العمليات | بوابة المنال" },
      {
        name: "description",
        content: "سجل العمليات الأمني في بوابة مدارس وروضة المنال: من نفّذ ماذا، ومن أي جهاز ومتى.",
      },
      { property: "og:title", content: "سجل العمليات | بوابة المنال" },
      { property: "og:description", content: "تتبّع كامل للعمليات الحساسة في بوابة المنال." },
...
function AuditPage() {
  ...
  return (
    <PortalLayout
      title="سجل العمليات ومصفوفة الصلاحيات"
      description="كل عملية حساسة تُسجَّل مع المنفّذ والجهاز وعنوان الإنترنت والنتيجة، مع عرض مصفوفة الصلاحيات المعتمدة."
    >
